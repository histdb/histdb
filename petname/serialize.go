...
func AppendTTo[K hashtbl.Key, RWK rwutils.RW[K], V num.T, RWV rwutils.RW[V]](t *T[K, V], w *rwutils.W) {
...
func ReadTFrom[K hashtbl.Key, RWK rwutils.RW[K], V num.T, RWV rwutils.RW[V]](t *T[K, V], r *rwutils.R) {
