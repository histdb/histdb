...
func (b *T64) AtomicAddIdx(idx uint32)   { atomic.AddUint64(&b.b, 1<<(idx&63)) }
func (b *T64) AtomicHas(idx uint32) bool { return atomic.LoadUint64(&b.b)&(1<<(idx&63)) > 0 }
...
func (b T64) Lowest() uint32             { return uint32(bits.TrailingZeros64(b.b)) % 64 }
func (b T64) Highest() uint32            { return uint32(63-bits.LeadingZeros64(b.b)) % 64 }
...
func (b *T32) AtomicAddIdx(idx uint32)   { atomic.AddUint32(&b.b, 1<<(idx&31)) }
func (b *T32) AtomicHas(idx uint32) bool { return atomic.LoadUint32(&b.b)&(1<<(idx&31)) > 0 }
...
func (b T32) Lowest() uint32             { return uint32(bits.TrailingZeros32(b.b)) % 32 }
func (b T32) Highest() uint32            { return uint32(31-bits.LeadingZeros32(b.b)) % 32 }
