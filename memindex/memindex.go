...
type T struct {
	...
	metrics    hashset.T[histdb.Hash, Id]
...
func (t *T) AppendMetricName(n Id, buf []byte) ([]byte, bool) {
	tagis := make([]Id, 0, 8)
...
func (t *T) MetricHashes(metrics *Bitmap, cb func(Id, histdb.Hash) bool) {
	iter(metrics, func(metricn Id) bool {
